...
os.environ["CUDA_VISIBLE_DEVICES"] = "2" # 训练时为"3"，预测时为""
...
if __name__ == "__main__":
    ...
    ## 神经网络相关
    name = "5*3*128_boundary"
    num_interior = 65000
    num_boundary = 15000 # 必须整除dim_x
    epochs = 100000
    Layers = [128, 128, 128] # 一个残差块中全连接网络结构，每层宽度都应该相等
    learning_rate = 0.001 # 初始学习率 
    boundary_weight = 100 # 设置太大可能导致梯度爆炸
    num_res = 5 # 每个x分量通道的残差块数量
